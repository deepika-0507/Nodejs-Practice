...
class AttachmentsBot extends ActivityHandler {
     ...
     */
    getInlineAttachment() {
        const imageData = fs.readFileSync(path.join(__dirname, '../resources/joker.png'));
    ...
    getInternetAttachment() {
        ...
        return {
            name: 'joker.png',
            contentType: 'image/png',
            contentUrl: 'https://docs.microsoft.com/en-us/bot-framework/media/how-it-works/joker.png'
        };
    }
